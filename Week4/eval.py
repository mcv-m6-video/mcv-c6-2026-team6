...
# Patch: np.asfarray was removed in NumPy 2.0 but motmetrics still uses it.
# This restores it as an alias for np.asarray with float dtype.
if not hasattr(np, 'asfarray'):
    np.asfarray = lambda a, dtype=float: np.asarray(a, dtype=dtype)
import pandas as pd
import scipy as sp
import motmetrics as mm
# import pytrec_eval as trec  # unused import — commented out
